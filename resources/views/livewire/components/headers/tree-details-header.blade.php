    ...
    <div class="card mb-5 mb-xl-10">
        <div class="card-body pt-9 pb-0">
                                        ...
                                        @foreach ($labelOptions as $label)
                                            <div class="form-check mb-8">
                                                <input class="form-check-input" type="checkbox"
                                                    value="{{ $label->id }}" wire:model="selectedLabels"
                                                    id="label_{{ $label->id }}">
            ...
            <ul class="nav nav-stretch nav-line-tabs nav-line-tabs-2x border-transparent fs-5 fw-bold" wire:ignore>
                ...
                <x-show-navbar-navitem title="{{ __('messages.health_records') }}" :route="route('tree.health-record', $tree->id)"
                    :active="request()->routeIs('tree.health-record')" />
