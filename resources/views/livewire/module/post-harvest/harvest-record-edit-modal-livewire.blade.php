<x-modal-component :id="$modalID" :title="$modalTitle">
    ...
    <div class="fv-row mb-8">
        <x-input-label for="harvest_date" class="mb-2" :value="__('messages.harvested_date')" />
    ...
    <div class="fv-row mb-8">
        ...
        <div class="d-flex w-full gap-5">
            <x-input-radio id="spoilt" name="spoilt" value="1" model="form.spoilt" label="{{ __('messages.yes') }}" />
            <x-input-radio id="spoilt" name="spoilt" value="0" model="form.spoilt" label="{{ __('messages.no') }}" />
        </div>
